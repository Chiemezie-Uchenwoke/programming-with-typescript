...
1. Use JavaScript's typeof operator as shown above to check if you're dealing with a string, number, boolean, object, function, symbol or bigint type

2. Use JavaScript's instanceof operator to check if an object value is based on some specific class

3. Use JavaScript's in operator to check if an object contains a specific property
